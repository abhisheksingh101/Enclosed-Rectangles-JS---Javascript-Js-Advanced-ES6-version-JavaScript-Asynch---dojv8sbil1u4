...
function solveCase1(rec1,rec2){
	...
	if(rec1Top <= rec2Top && rec1left <= rec2left && rec1left+rec1wd >= rec2left+rec2wd && rec1Top+rec1ht >= rec2Top+rec2ht){
		return {
			...rec1,
			children : [{
	...
	if(rec2Top <= rec1Top && rec2left <= rec1left && rec2left+rec2wd >= rec1left+rec1wd && rec2Top+rec2ht >= rec1Top+rec1ht){
		return {
			...rec2,
			children : [{
...
function solveCase2(rec1,rec2){
	...
	if(rec1Top <= rec2Top && rec1left <= rec2left && rec1rt <= rec2rt && rec1bt <= rec2bt){
		return {
			...rec1,
			children : [{
				top: Math.abs(rec2Top-rec1Top)+'px',
	...
	if(rec2Top <= rec1Top && rec2left <= rec1left && rec2rt <= rec1rt && rec2bt <= rec1bt){
		return {
			...rec2,
			children : [{
				top: Math.abs(rec2Top-rec1Top)+'px',
